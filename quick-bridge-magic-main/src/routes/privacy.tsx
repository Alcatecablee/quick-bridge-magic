...
const PAGE_TITLE = "QuickBridge Privacy 2026: Your Data Stays on Your Devices";
const PAGE_DESCRIPTION =
  "In 2026, QuickBridge never stores your files, never uploads your data, and never tracks what you send. Files go directly between your two browsers via WebRTC.";
const PAGE_URL = "https://quickbridge.app/privacy";
const PAGE_OG_IMAGE = "https://quickbridge.app/og-privacy.png";
const PAGE_OG_ALT =
  "QuickBridge privacy: files go directly between browsers. No server ever sees your data.";
...
const PRINCIPLES: { Icon: typeof Lock; title: string; body: string }[] = [
  {
    ...
    body: "Files travel directly between your two devices over an encrypted WebRTC channel. There is no copy on a QuickBridge server, because there is no QuickBridge server in that path at all.",
  },
  {
    Icon: ShieldCheck,
    title: "We don't upload your data",
    body: "Photos, documents, clipboard text, whatever you send. It stays on the two devices you connected. Nothing is staged, mirrored or sitting in a backup somewhere.",
  },
  {
    Icon: Eye,
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <h1 className="mt-3 text-balance tracking-tight text-foreground font-black text-[46px] sm:text-[64px] md:text-[84px]">
            Your data stays{" "}
            <span className="text-muted-foreground">on your devices in 2026.</span>
          </h1>
          <p className="mx-auto mt-3 max-w-3xl text-[16px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[18px]">
            Genuinely, by design, we cannot see your files even if we wanted to. Everything moves straight between the two devices you are using. That is the whole point.
          </p>
