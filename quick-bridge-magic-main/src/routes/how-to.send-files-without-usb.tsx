...
const PAGE_TITLE =
  "How to Transfer Files Without USB Cable 2026 - Any OS";
const PAGE_DESCRIPTION =
  "In 2026, open on your phone. Open the same site on your PC and scan the QR. No USB cable, no drivers, no apps. Works across any OS and network. Free.";
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <h1 className="mt-3 text-balance font-black tracking-tight text-foreground text-[46px] sm:text-[64px] md:text-[84px]">
            No cable needed.{" "}
            <span className="text-muted-foreground">Any device, any network in 2026.</span>
          </h1>
          <p className="mt-2 text-[12px] text-muted-foreground">
            Updated June 2026
          </p>
          <p className="mx-auto mt-3 max-w-3xl text-[16px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[18px]">
            USB cables want the right port, the right driver, and sometimes a
            trust prompt you have to tap on a locked screen. Bluetooth is slow.
            You really shouldn't need either for a simple file transfer. This
            guide moves files over any network with nothing but a browser and
            a QR scan.
          </p>
