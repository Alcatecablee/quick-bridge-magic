...
const PAGE_TITLE =
  "How to Send Large Files Phone to PC 2026 - Up to 10 GB";
const PAGE_DESCRIPTION =
  "In 2026, open on your phone. On your PC, scan the QR. Large files stream directly up to 10 GB, no cloud upload, no size paywall. No account needed.";
const PAGE_URL =
  "https://quickbridge.app/how-to/send-large-files-phone-to-pc";
const PAGE_OG_IMAGE = "https://quickbridge.app/og-howto-send-large-files.png";
const PAGE_OG_ALT =
  "How to send large files up to 10 GB from phone to PC. No cloud upload, no size limit. QuickBridge.";
...
const STEPS = [
  {
    ...
    body: "Go to quickbridge.app in Chrome or Edge on your PC. Once the QR appears, find the auto-save toggle in the receiver panel and turn it on. This streams large files directly to disk instead of buffering in RAM, raising the per-file limit from 2 GB to 10 GB.",
  },
  {
    n: "02",
  ...
  },
  {
    ...
    body: "Use your camera to scan the QR code on your PC screen. The transfer page opens in your mobile browser. On iPhone that is Safari. On Android that is Chrome.",
  },
  {
    n: "04",
    title: "Select your large file on the phone",
    body: "Tap the file picker on your phone. Navigate to your video, archive, or large document. Select it and tap Send. A progress bar appears on both screens the moment it starts.",
  },
  {
    n: "05",
...
const BREADCRUMB_JSONLD = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Large files phone to PC", item: PAGE_URL },
  ],
};
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <h1 className="mt-3 text-balance font-black tracking-tight text-foreground text-[46px] sm:text-[64px] md:text-[84px]">
            ...
            <span className="text-muted-foreground">No upload. Up to 10 GB in 2026.</span>
          </h1>
          <p className="mt-2 text-[12px] text-muted-foreground">
            Updated June 2026
          </p>
          <p className="mx-auto mt-3 max-w-3xl text-[16px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[18px]">
            Cloud services cap free storage, compress videos, and make you watch
            a progress bar on the upload before you can even start the download
            on the other side. QuickBridge skips that step entirely. Files
            stream directly from your phone to your PC at local network speed,
          ...
          <p className="mt-3 text-[12px] text-muted-foreground">
            Up to 10 GB per file · No upload step
          </p>
        </header>
        ...
        {/* Cross-promo: large video files often need editing next */}
        <Reveal as="section" className="mt-16">
