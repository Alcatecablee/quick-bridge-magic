...
const PAGE_TITLE =
  "How to Send Videos Phone to PC 2026 - Full Quality";
const PAGE_DESCRIPTION =
  "In 2026, open on your phone. On your PC, open the same site and scan the QR. Videos arrive at original quality. No WhatsApp compression, no size limits.";
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <h1 className="mt-3 text-balance font-black tracking-tight text-foreground text-[46px] sm:text-[64px] md:text-[84px]">
            ...
            <span className="text-muted-foreground">No compression, no upload in 2026.</span>
          </h1>
          <p className="mt-2 text-[12px] text-muted-foreground">
            Updated June 2026
          </p>
          <p className="mx-auto mt-3 max-w-3xl text-[16px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[18px]">
            WhatsApp compression turns a decent video into something you'd be
            embarrassed to show anyone. Emailing it runs into size limits almost
            immediately. Uploading to Google Drive takes about as long as
            watching the video twice. This moves it directly, original quality,
