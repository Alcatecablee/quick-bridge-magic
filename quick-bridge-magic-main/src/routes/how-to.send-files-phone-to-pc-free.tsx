...
const PAGE_TITLE =
  "How to Send Files Phone to PC Free 2026 - No App";
const PAGE_DESCRIPTION =
  "In 2026, open on your phone. On your PC, scan the QR. Files go directly between devices. Free, no subscription, no ads, no account required.";
const PAGE_URL =
  "https://quickbridge.app/how-to/send-files-phone-to-pc-free";
const PAGE_OG_IMAGE = "https://quickbridge.app/og-howto-send-free.png";
const PAGE_OG_ALT =
  "How to send files from phone to PC free. No account, no subscription, no ads. QuickBridge.";
...
const STEPS = [
  {
    ...
    body: "Go to quickbridge.app in any browser. The QR code appears immediately. No account, no credit card, no trial period.",
  },
  {
    n: "02",
    title: "Scan the QR on your phone",
    body: "Open your camera and hold it over the QR code on your PC screen. A link appears, tap it, and the transfer page opens on your phone.",
  },
  {
    n: "03",
  ...
  },
  {
    ...
    body: "Tap the file picker on your phone, choose your file, and tap Send. The transfer starts immediately.",
  },
  {
    n: "05",
    title: "File arrives on your PC",
    body: "The browser download prompt appears. Your file lands in Downloads. Nothing was uploaded to any server.",
  },
];
...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  {
    q: "Why is QuickBridge free with no paid tier?",
    a: "The architecture makes a paid tier unnecessary. Files travel directly between two browsers over an encrypted WebRTC channel - QuickBridge never stores them. No storage means no storage bill, and no storage bill means no reason to charge. The project roadmap explicitly skips a monetization phase to preserve the 'no accounts, nothing stored' identity.",
  },
  {
...
const BREADCRUMB_JSONLD = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Free file transfer", item: PAGE_URL },
  ],
};
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <h1 className="mt-3 text-balance font-black tracking-tight text-foreground text-[46px] sm:text-[64px] md:text-[84px]">
            ...
            <span className="text-muted-foreground">No subscription, no account in 2026.</span>
          </h1>
          <p className="mt-2 text-[12px] text-muted-foreground">
            Updated June 2026
          </p>
          <p className="mx-auto mt-3 max-w-3xl text-[16px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[18px]">
            Most "free" tools have a catch somewhere: a file size cap, a daily
            limit, a signup wall after your first transfer. QuickBridge doesn't
            store your files at all, so there's genuinely nothing to charge
            for. It's free because the architecture makes anything else kind
            of unnecessary.
          </p>
