...
const PAGE_TITLE =
  "QuickBridge Help 2026: Transfers & Troubleshooting Guide";
const PAGE_DESCRIPTION =
  "QuickBridge help guide for 2026: connect devices, send and receive files up to 10 GB, save to disk, verify your security code, and fix transfer issues fast.";
const PAGE_URL = "https://quickbridge.app/help";
const PAGE_OG_IMAGE = "https://quickbridge.app/og-home.png";
const PAGE_OG_ALT =
  "QuickBridge help and FAQ: how to send files, fix connections, and get the most from the app.";
...
const FAQS_SECURITY: FaqItem[] = [
  ...
  },
  {
    ...
    a: "QuickBridge is best for anyone who needs to move files between two devices in real time without a USB cable, account, or app install. Both devices need to have a browser open at the same time. Choose a cloud service like Google Drive when the recipient will not be online right away, or use AirDrop when both devices are Apple and within 10 metres of each other.",
  },
];
...
const HELP_BREADCRUMB_JSONLD = {
  "@context": "https://schema.org",
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Home", item: "https://quickbridge.app/" },
    { "@type": "ListItem", position: 2, name: "Help Center", item: PAGE_URL },
  ],
};
...
function HelpPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(HELP_BREADCRUMB_JSONLD) }}
      />
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <h1 className="mt-3 text-balance tracking-tight text-foreground font-black text-[46px] sm:text-[64px] md:text-[84px]">
            Find an answer{" "}
            <span className="text-muted-foreground">in 30 seconds. 2026 guide.</span>
          </h1>
          <p className="mx-auto mt-3 max-w-3xl text-[16px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[18px]">
            Everything you might need in one place. Connecting, sending, the security stuff, and what to do when something doesn't quite work. Most questions are a short paragraph to answer, honestly.
          </p>
        ...
        <Reveal as="section" className="mt-14 sm:mt-16">
          ...
          <p className="mt-3 max-w-2xl text-[14.5px] leading-relaxed text-muted-foreground">
            Four steps total. Three of them get the connection set up, and after that it's just you sending stuff.
          </p>
          <div className="mt-6">
            <TransferFlowInfographic />
          </div>
        ...
        <Reveal as="section" id="topics" className="mt-16 scroll-mt-24">
          ...
          <p className="mt-3 max-w-2xl text-[14.5px] leading-relaxed text-muted-foreground">
            Six sections. Tap any of them to jump straight to the questions, or just scroll through if you'd rather.
          </p>
        ...
        <Reveal as="section" className="mt-16">
          ...
          <p className="mt-3 max-w-2xl text-[14.5px] leading-relaxed text-muted-foreground">
            If all four of these are true, you're good. Everything is going direct and nothing is being copied somewhere it shouldn't be.
          </p>
        ...
        {/* Cross-promo: CalmPC for users whose device is struggling */}
        <Reveal as="section" className="mt-16">
          <div className="flex flex-col gap-4 rounded-2xl border border-border bg-card/60 p-5 sm:flex-row sm:items-start sm:gap-5 sm:p-6">
            <span className="text-2xl" aria-hidden>🖥️</span>
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-wider text-primary">Is your PC the problem?</p>
              ...
              <p className="mt-1.5 text-[13px] leading-relaxed text-muted-foreground">
                Transfer issues are sometimes caused by an overloaded PC: high CPU, a full disk, or a Wi-Fi driver that's quietly misbehaving. CalmPC runs a free health check in your browser and walks you through fixes in plain English.
              </p>
              <a
                href="https://calmpc.com"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-3 inline-flex items-center gap-1.5 text-[13px] font-medium text-primary underline-offset-2 hover:underline"
              >
                Run a free PC health check at CalmPC <ArrowRight className="h-3.5 w-3.5" />
              </a>
            </div>
          </div>
        </Reveal>
        ...
        <Reveal as="section" className="mt-16">
          ...
          <p className="mt-3 max-w-2xl text-[14.5px] leading-relaxed text-muted-foreground">
            We read every message, genuinely. If none of this helped, just drop us a note. Tell us what you tried and what the status badge was showing when it went wrong, and we'll figure it out.
          </p>
