...
const PAGE_TITLE =
  "How to Send Files iPhone to Windows PC 2026 (Free, No Cable)";
const PAGE_DESCRIPTION =
  "In 2026, open on your iPhone. On your Windows PC, scan the QR. Files transfer wirelessly: no iTunes, no iCloud, no app install required. Free.";
const PAGE_URL =
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <h1 className="mt-3 text-balance font-black tracking-tight text-foreground text-[46px] sm:text-[64px] md:text-[84px]">
            iPhone to Windows{" "}
            <span className="text-muted-foreground">without a cable or iTunes in 2026.</span>
          </h1>
          <p className="mt-2 text-[12px] text-muted-foreground">
            Updated June 2026
          </p>
          <p className="mx-auto mt-3 max-w-3xl text-[16px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[18px]">
            Apple and Windows just don't really talk to each other. There's no
            AirDrop for Windows, and iTunes. Well, you already know. This
            guide uses a browser tab on each side and works around the whole
            ecosystem problem in about five steps.
          </p>
