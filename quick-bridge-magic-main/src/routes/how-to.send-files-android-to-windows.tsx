...
const PAGE_TITLE =
  "How to Send Files Android to Windows PC 2026 (No Cable)";
const PAGE_DESCRIPTION =
  "In 2026, open on your Android phone. On your Windows PC, scan the QR. Files transfer wirelessly: no USB cable, no app, no account required. Free.";
const PAGE_URL =
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <h1 className="mt-3 text-balance font-black tracking-tight text-foreground text-[46px] sm:text-[64px] md:text-[84px]">
            Android to Windows{" "}
            <span className="text-muted-foreground">no cable, no Bluetooth pairing in 2026.</span>
          </h1>
          <p className="mt-2 text-[12px] text-muted-foreground">
            Updated June 2026
          </p>
          <p className="mx-auto mt-3 max-w-3xl text-[16px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[18px]">
            USB usually works. Until it doesn't. MTP mode has a way of going
            quiet at exactly the wrong moment, and reinstalling drivers at
            midnight isn't anyone's idea of a good time. This guide skips the
            cable entirely: browser on the PC, camera on the Android, done.
          </p>
