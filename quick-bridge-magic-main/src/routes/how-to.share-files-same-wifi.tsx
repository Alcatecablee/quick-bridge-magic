...
const PAGE_TITLE =
  "How to Share Files Same Wi-Fi 2026: Phone to PC, No App";
const PAGE_DESCRIPTION =
  "Open on your phone. On your PC, scan the QR. Same Wi-Fi in 2026 means maximum local speed. No apps, no accounts, no setup, just browser-to-browser.";
const PAGE_URL = "https://quickbridge.app/how-to/share-files-same-wifi";
const PAGE_OG_IMAGE = "https://quickbridge.app/og-howto-same-wifi.png";
const PAGE_OG_ALT =
  "How to share files on the same Wi-Fi network. Scan the QR and transfer direct. QuickBridge.";
...
const STEPS = [
  {
    ...
    body: "Go to quickbridge.app in your browser. A QR code and 6-digit PIN appear. Both devices on the same Wi-Fi gets you the fastest direct connection, but it also works across different networks.",
  },
  {
    n: "02",
    title: "Connect from your phone",
    body: "Scan the QR code with your phone's camera, or open quickbridge.app on your phone and enter the 6-digit PIN. The transfer page opens on your phone.",
  },
  {
    n: "03",
  ...
  },
  {
    ...
    body: "Either device can send. Drag files from your PC into the browser tab, or use the file picker on your phone. The session stays open for both directions. No need to re-scan for a return transfer.",
  },
  {
    n: "05",
...
const BREADCRUMB_JSONLD = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Same Wi-Fi transfer", item: PAGE_URL },
  ],
};
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <h1 className="mt-3 text-balance font-black tracking-tight text-foreground text-[46px] sm:text-[64px] md:text-[84px]">
            ...
            <span className="text-muted-foreground">The fastest transfer possible in 2026.</span>
          </h1>
          <p className="mt-2 text-[12px] text-muted-foreground">
            Updated June 2026
          </p>
          <p className="mx-auto mt-3 max-w-3xl text-[16px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[18px]">
            When both devices are on the same network, QuickBridge routes the
            connection locally. No internet bandwidth used, no upload step, no
            server involved. Files move at whatever speed your router allows,
            which on a home network is usually pretty fast.
          </p>
          ...
          <p className="mt-3 text-[12px] text-muted-foreground">
            Local network speed · No account
          </p>
        </header>
