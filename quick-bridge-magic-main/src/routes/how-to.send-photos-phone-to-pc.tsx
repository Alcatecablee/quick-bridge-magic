...
const PAGE_TITLE =
  "How to Send Photos from Phone to PC 2026 - No Cloud";
const PAGE_DESCRIPTION =
  "In 2026, open on your phone. On your Windows or Mac, open the same site and scan the QR. Photos transfer without iCloud, Google Photos, or email. Free.";
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <h1 className="mt-3 text-balance font-black tracking-tight text-foreground text-[46px] sm:text-[64px] md:text-[84px]">
            ...
            <span className="text-muted-foreground">without email or cloud upload in 2026.</span>
          </h1>
          ...
          <p className="mx-auto mt-3 max-w-3xl text-[16px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[18px]">
            ...
            Google Photos takes time, chews through your storage quota, and
            routes your pictures through someone else's server. This transfers
            photos directly from phone to PC: original quality, under a
            minute, nothing uploaded anywhere.
          </p>
