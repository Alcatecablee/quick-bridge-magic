...
const PAGE_TITLE =
  "How to Send Files Windows PC to iPhone 2026 (No iTunes)";
const PAGE_DESCRIPTION =
  "Transfer files from a Windows PC to an iPhone wirelessly in 2026. No iTunes, no iCloud required. Open a browser on both devices, scan the QR, done.";
const PAGE_URL =
  "https://quickbridge.app/how-to/send-files-windows-to-iphone";
const PAGE_OG_IMAGE =
  "https://quickbridge.app/og-howto-windows-to-iphone.png";
const PAGE_OG_ALT =
  "How to send files from Windows to iPhone without iTunes. Scan the QR and go. QuickBridge.";
...
const STEPS = [
  {
    ...
    body: "Go to quickbridge.app in Chrome or Edge. A QR code appears as soon as the page loads. This is the session your iPhone will join.",
  },
  {
    n: "02",
    title: "Scan the QR with your iPhone camera",
    body: "Open the Camera app on your iPhone and hold it over the QR code on your PC screen. A banner appears at the top, tap it, and Safari opens the transfer page.",
  },
  {
    n: "03",
  ...
  },
  {
    ...
    body: "Drag a file from Windows Explorer into the QuickBridge browser tab. You can also use the file picker or paste from your clipboard. The file starts streaming to your iPhone immediately.",
  },
  {
    n: "05",
    title: "Open or save the file on your iPhone",
    body: "Safari shows a download notification. Tap it to open the file in a compatible app, save it to Files, or share it to Photos. iOS figures out the right app based on the file type.",
  },
];
...
const FAQ_ITEMS: { q: string; a: string }[] = [
  {
    ...
    a: "AirDrop is Apple-only. A Windows PC cannot send to an iPhone via AirDrop, full stop. QuickBridge runs in the browser on both sides, so Windows and iOS connect without any Apple-specific protocol.",
  },
  {
...
const BREADCRUMB_JSONLD = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Windows to iPhone", item: PAGE_URL },
  ],
};
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <h1 className="mt-3 text-balance font-black tracking-tight text-foreground text-[46px] sm:text-[64px] md:text-[84px]">
            Windows to iPhone.{" "}
            <span className="text-muted-foreground">No iTunes, no cable in 2026.</span>
          </h1>
          <p className="mt-2 text-[12px] text-muted-foreground">
            Updated June 2026
          </p>
          <p className="mx-auto mt-3 max-w-3xl text-[16px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[18px]">
            Getting a file from Windows to an iPhone is one of those things
            that feels like it should just work, but usually ends up being a
            whole thing. No AirDrop, iCloud storage limits, iTunes doing what
            iTunes does. This guide skips all of it: just a browser tab on
            each side.
          </p>
