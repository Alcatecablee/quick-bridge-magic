  ...
  return (
    <div className={cn("w-full text-[11px]", className)}>
      ...
      <div className="mt-1.5 pl-[22px]">
        <span className="text-xl leading-none tracking-wide" aria-label="Security verification code">
          {code.emoji.join("  ")}
        </span>
      </div>
      <p className="mt-1 pl-[22px] text-[10.5px] leading-snug text-muted-foreground/80">
        {open
          ? code.words.join(" · ")
