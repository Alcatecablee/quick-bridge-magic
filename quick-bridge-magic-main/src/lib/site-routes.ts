...
/** Contact page - WhatsApp and Tally form. inNav: false keeps it out of nav dropdowns; footer links to it directly. */
export const CONTACT_ROUTE: SiteRoute = {
  href: "/contact",
  label: "Contact",
  teaser: "Reach the QuickBridge team via WhatsApp or contact form.",
  inNav: false,
};

/** Demo video page - animated walkthrough of the pairing and transfer flow. inNav: false keeps it out of nav dropdowns; footer links to it directly. */
export const VIDEO_ROUTE: SiteRoute = {
  href: "/video",
  label: "Demo video",
  teaser: "Watch QuickBridge pair and transfer files in under 90 seconds.",
  inNav: false,
};

/** Partners page - recommended tools and services. inNav: false keeps it out of nav dropdowns; footer links to it directly. */
export const PARTNERS_ROUTE: SiteRoute = {
  href: "/partners",
  label: "Partners",
  teaser: "Recommended tools and services from the QuickBridge team.",
  inNav: false,
};
