...
export const StorageKeys = {
  // Bootstrap pointer for the local node identity. The actual keypair lives in
  // QuickBridgeDB (IndexedDB). This key is checked on startup so node-identity.ts
  // can detect an existing nodeId even after the IDB record is wiped.
