            ...
            <tr>
              <td style="padding:24px 32px 8px 32px;">
                ...
                <p style="margin:8px 0 0 0;font-size:14px;line-height:1.55;color:#d1d5db;">
                  Thanks for reaching out through quickbridge.app. We&#39;ll get back to you at the email you provided as soon as we can, usually within a business day.
                </p>
              </td>
            </tr>
            <tr>
  ...
  try {
    await Promise.race([
      ...
      new Promise<never>((_, reject) =>
        setTimeout(() => reject(new Error("ack_timeout")), 5000),
      ),
    ]);
  } catch {
