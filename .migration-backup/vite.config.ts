...
export default defineConfig({
  ...
  tanstackStart: {
    ...
    pages: [
      ...
      {
        path: "/compare/quickbridge-vs-nearby-share",
        prerender: { enabled: true, crawlLinks: false },
        sitemap: { priority: 0.8, changefreq: "monthly" },
      },
      {
        path: "/compare/quickbridge-vs-filepizza",
        prerender: { enabled: true, crawlLinks: false },
        sitemap: { priority: 0.8, changefreq: "monthly" },
      },
      {
        path: "/compare/quickbridge-vs-localsend",
        prerender: { enabled: true, crawlLinks: false },
        sitemap: { priority: 0.8, changefreq: "monthly" },
      },
      {
      ...
      {
        path: "/how-to/send-videos-phone-to-pc",
        prerender: { enabled: true, crawlLinks: false },
        sitemap: { priority: 0.7, changefreq: "monthly" },
      },
      {
        path: "/how-to/send-files-without-usb",
        prerender: { enabled: true, crawlLinks: false },
        sitemap: { priority: 0.7, changefreq: "monthly" },
      },
      {
        path: "/how-to/share-clipboard-between-devices",
        prerender: { enabled: true, crawlLinks: false },
        sitemap: { priority: 0.7, changefreq: "monthly" },
      },
    ],
