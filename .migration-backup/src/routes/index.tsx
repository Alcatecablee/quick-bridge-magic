...
function Home() {
  ...
  useEffect(() => {
    ...
    return () => {
      console.log(`[QB] Lobby: cleaning up channel qb:${sessionId}`);
      aborted = true;
      if (lobbyRetryTimer) {
      ...
      <main className="relative mx-auto max-w-6xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <section className="mb-7 text-center sm:mb-10">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-[13.5px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[15px]">
            Open the site on any device, scan the QR on the other, and you are connected. Files stream directly between your two browsers, nothing stored anywhere in between.
          </p>
        ...
        <div className="mb-8 overflow-hidden rounded-xl border border-border">
          <div className="grid grid-cols-2 divide-x divide-y divide-border sm:grid-cols-4 sm:divide-y-0">
            {[
              ...
              <div key={label} className="relative flex flex-col items-center px-4 py-4 text-center">
                <div className="absolute inset-x-0 top-0 h-[2px] bg-primary" />
                <span className="text-[22px] font-black leading-none tracking-tight text-foreground tabular-nums">
                  {value}
                </span>
                <span className="mt-1.5 text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">
                  {label}
                </span>
                <span className="mt-0.5 text-[10px] text-muted-foreground/40">{sub}</span>
              </div>
            ))}
          </div>
          <div className="grid grid-cols-2 divide-x divide-y divide-border border-t border-border bg-card/30 sm:grid-cols-4 sm:divide-y-0">
            {[
              { value: "DTLS", label: "E2E encrypted", sub: "Including over relay" },
              { value: "Auto", label: "Tab sleep safe", sub: "No lost progress" },
              { value: "Live", label: "Relay status", sub: "Shown in session header" },
              { value: "Yes", label: "Transfers resume", sub: "On reconnect" },
            ].map(({ value, label, sub }) => (
              <div key={label} className="flex flex-col items-center px-4 py-3 text-center">
                <span className="text-[16px] font-bold leading-none tracking-tight text-primary tabular-nums">
                  {value}
                </span>
                <span className="mt-1.5 text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">
                  {label}
        ...
        <Reveal as="section" id="how" className="mt-16 scroll-mt-24 sm:mt-20">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-2 text-balance text-2xl font-semibold tracking-tight text-foreground sm:text-3xl md:text-4xl">
              Open. Scan. Send. Under five seconds.
            </h2>
          </div>
        ...
        <Reveal as="section" id="why" className="mt-16 scroll-mt-24 sm:mt-20">
          ...
          <div className="mt-10 grid gap-0 sm:grid-cols-3 divide-y divide-border sm:divide-y-0 sm:divide-x">
            {[
              {
              ...
              <div key={title} className="flex flex-col py-6 sm:px-8 sm:first:pl-0 sm:last:pr-0">
                <div className="mb-4 flex items-center gap-3">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-border bg-card">
                    <Art className="h-5 w-5 text-primary" />
                  </div>
                  <span className="font-mono text-[11px] font-semibold text-muted-foreground/50">0{i + 1}</span>
                </div>
          ...
          <div className="mt-10 overflow-hidden rounded-xl border border-border">
            <div className="grid grid-cols-1 divide-y divide-border sm:grid-cols-2 sm:divide-x lg:grid-cols-3">
              {[
                ...
                {
                  Art: P2PIllustration,
                  title: "Streams browser to browser",
                ...
                },
                {
                  ...
                  title: "Android, iPhone, Windows, Mac, Linux",
                ...
                },
                {
                  ...
                  title: "Text, links, and clipboard too",
                ...
                <div key={title} className={`flex flex-col p-6${i >= 3 ? " border-t border-border" : ""}`}>
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-border bg-card">
                    <Art className="h-5 w-5 text-primary" />
                  </div>
        ...
        <Reveal as="section" className="mt-20 sm:mt-28">
          <div className="text-center">
            ...
            <h2 className="mt-2 text-balance text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">
              More privacy tools that run in your browser.
            </h2>
            <p className="mx-auto mt-3 max-w-lg text-[14px] leading-relaxed text-muted-foreground">
              Same philosophy: no accounts, no uploads, no tracking. Everything stays on your device.
            </p>
          </div>
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <a
              href="https://calmpc.com?ref=quickbridge"
              target="_blank"
              rel="noopener noreferrer"
              className="group rounded-2xl border border-border bg-card p-6 transition-colors hover:border-primary/40 flex flex-col"
            >
              <div
                aria-label="CalmPC"
                style={{ width: 96, height: 40, backgroundImage: 'url(/calmpc-logo.png)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'left center', flexShrink: 0 }}
              />
              <h3 className="mt-3 text-[16px] font-semibold text-foreground transition-colors group-hover:text-primary">CalmPC</h3>
              <p className="mt-1.5 text-[13.5px] leading-relaxed text-muted-foreground flex-1">
                Free computer health check. Diagnoses slow PCs, broken Wi-Fi, USB issues, and more. Step-by-step fixes in plain English. No download, no account -- runs in your browser right now.
              </p>
            ...
            >
              <div
                aria-label="CalmClip"
                style={{ width: 96, height: 40, backgroundImage: 'url(/calmclip-logo.png)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'left center', flexShrink: 0 }}
              />
              <h3 className="mt-3 text-[16px] font-semibold text-foreground transition-colors group-hover:text-primary">CalmClip</h3>
              <p className="mt-1.5 text-[13.5px] leading-relaxed text-muted-foreground flex-1">
                Local AI video editor. Transcription, silence removal, word-level captions, and multi-ratio export -- all running in your browser with WebAssembly. Your footage never leaves your device.
              </p>
              <span className="mt-4 inline-flex items-center gap-1 text-[12.5px] font-medium text-primary">
        ...
        {/* CTA banner */}
        <Reveal as="section" className="mt-20 sm:mt-28">
          <div className="border-t border-border/40 pt-12 sm:pt-16">
            <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-primary">
                  AirDrop for any device
                </p>
                <h2 className="mt-2 text-balance text-[28px] font-black tracking-tight text-foreground sm:text-[36px] md:text-[44px]">
                  Stop emailing yourself files.
                </h2>
              </div>
              <div className="flex shrink-0 flex-col items-start gap-3 sm:items-end">
                <p className="text-[13px] leading-relaxed text-muted-foreground sm:text-right">
                  Scan the QR above. Connected in under 5 seconds.
                </p>
                <Button
