...
const PAGE_TITLE =
  "How to Send Files from Phone to PC Free (No Subscription)";
const PAGE_DESCRIPTION =
  "Open this on your phone. On your PC, open the same site and scan the QR. Files go directly between devices. Free, no subscription, no ads, no account.";
const PAGE_URL =
