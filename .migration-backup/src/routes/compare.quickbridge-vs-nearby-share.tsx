...
const PAGE_TITLE =
  "QuickBridge vs Nearby Share: Browser vs OS Feature";
const PAGE_DESCRIPTION =
  "Nearby Share works only between nearby Android and Windows devices. QuickBridge runs in any browser and transfers files across any network. Compare both.";
const PAGE_URL =
...
const ARTICLE_JSONLD = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "QuickBridge vs Nearby Share (Quick Share)",
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-[13.5px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[15px]">
            ...
            Nearby Share (now called Quick Share) is excellent for same-room
            transfers between Android phones and Windows PCs. No scan, no code,
            devices just appear. QuickBridge is for everything Nearby Share
            cannot do: cross-network transfers, iPhone, Mac, Linux, and any
            scenario where the two devices are not physically close to each
            other.
          </p>
