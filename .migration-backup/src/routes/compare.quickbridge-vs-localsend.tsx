...
const PAGE_TITLE =
  "QuickBridge vs LocalSend: Browser vs Native App";
const PAGE_DESCRIPTION =
  "LocalSend is a fast LAN file transfer app that requires installation. QuickBridge needs no install and works across networks. Compare both tools.";
...
const ARTICLE_JSONLD = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "QuickBridge vs LocalSend",
      ...
      <main className="relative mx-auto max-w-4xl px-4 pb-24 pt-6 sm:px-6 sm:pt-12">
        ...
        <header className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-[13.5px] leading-relaxed text-muted-foreground sm:mt-4 sm:text-[15px]">
            ...
            LocalSend is one of the best tools available for frequent same-network
            transfers: fast, install it once and it works offline, auto-discovers
            all devices on the LAN, and has no file size limit. QuickBridge is
            built for everything LocalSend cannot do: transfers across different
            networks, install-free access from any device, and one-off sends to
            devices that don't have any app installed.
          </p>
