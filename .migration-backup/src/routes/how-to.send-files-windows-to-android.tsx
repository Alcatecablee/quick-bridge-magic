...
const PAGE_TITLE =
  "How to Send Files from Windows PC to Android (Wireless)";
const PAGE_DESCRIPTION =
  "Push files from a Windows computer to your Android phone without a USB cable. Drag and drop in your browser, scan the QR on your phone, done.";
const PAGE_URL =
