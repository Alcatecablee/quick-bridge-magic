...
const PAGE_DESCRIPTION =
  "Step-by-step help for QuickBridge: how to connect devices, send and receive files up to 10 GB, save to disk, verify the security code, and fix transfer issues.";
