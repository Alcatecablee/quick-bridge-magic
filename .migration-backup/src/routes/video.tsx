...
const PAGE_TITLE       = 'How QuickBridge Works - Send Files Between Devices Instantly'
const PAGE_DESCRIPTION = 'Watch how QuickBridge transfers files between phone and PC in seconds. Open the site on both devices, scan the QR code, and send. No app, no sign-up, no cloud.'
